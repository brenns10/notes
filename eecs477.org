...
*** Game Theory Approach to Game Tree Evaluation
    ...
    *Question:* Hee's a deterministic algorithm.  Show that it examines all
    leaves.
...
*** Randomized Algorithms
    ...
    RA's base ther decisions on a random number generator.
    ...
    - choose a strategy in S^2 at random, with /any/ probability dsitribution
      over S^2.
